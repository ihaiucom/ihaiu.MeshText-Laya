...
export class MapBuff
{
    buff: Array<number>;
    offset: number;
    constructor(buff: Array<number>, offset: number)
    {
        this.buff = buff;
        this.offset = offset;
    }
...
export default class ComponentPropBaseBuff
{
    buff: Array<number>;
 	/** 战斗基础属性 */
    bases:MapBuff;
    ...
    constructor()
    {
        ...
        this.buff = new Array<number>(length);
    ...
    clone():ComponentPropBaseBuff
    {
        ...
        com.buff.length = 0;
        var buff = com.buff = this.buff.slice();

        com.bases.buff = buff;
        com.adds.buff = buff;
        com.addpers.buff = buff;
        com.addPersAll.buff = buff;
        com.finals.buff = buff;
